const testeconsertos = require('./consertos.js');
/*
...
testeconsertos.consertos.forEach(aparelhos => {
...
testeconsertos.consertos.forEach(aparelhos2 => {
 ...
 console.log(`Aparelho: ${aparelhos2.aparelho}
              Itens Consertados: ${aparelhos2.itensConsertados} 
